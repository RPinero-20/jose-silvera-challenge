...
let mission = document.getElementById('mission').addEventListener('click', () => description.innerHTML = `<p class = "text-color">${MISSION}</p>`);
let vision = document.getElementById('vision').addEventListener('click', () => description.innerHTML = `<p class = "text-color">${VISION}</p>`);
let value = document.getElementById('value').addEventListener('click', () => description.innerHTML = `<p class = "text-color">${VALUE}</p>`);

description.innerHTML = `<p class = "text-color">${MISSION}</p>`;